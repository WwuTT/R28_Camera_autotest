...
class Test_func():
    ...
    parametrize_info = [
        ...
        'time_delay_off',
        'shutter_sound_off',
        'avodi_flashing_off', 'avodi_flashing_60hz', 'avodi_flashing_50hz',
        'Focus_sound_off',
        'logo_on',
        'position_logo_on',
        'time_logo_on',
        'photo_size_16m_18_9', 'photo_size_8m_18_9', 'photo_size_8m_4_3',
        'loc_info_on',
    ]
    front_parametrize_info = [
        ...
        'position_logo_on',
        'time_logo_on',
        'photo_size_8m_18_9',  'photo_size_2m_16_9', 'photo_size_2m_4_3',
        'loc_info_on',
    ]
    ...
    def test_1_click_photo(self, parametrize_info):
        ...
        try:
            # 开关
            if parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    def test_1_click_photo_on_facing(self, front_parametrize_info):
        ...
        try:
            # 开关
            if front_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif front_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    # 美颜拍照 192
    @pytest.mark.parametrize("beauty_parametrize_info", parametrize_info)
    def test_2_beauty_photo(self, beauty_parametrize_info):
        ...
        try:
            # 开关
            if beauty_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif beauty_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')

            elif beauty_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif beauty_parametrize_info == 'time_delay_off':
                self.setting.time_delay()
                print('关闭零延时')

            elif beauty_parametrize_info == 'shutter_sound_off':
                self.setting.shutter_sound()
                print('关闭快门声音')

            elif beauty_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif beauty_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif beauty_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif beauty_parametrize_info == 'Focus_sound_off':
                self.setting.Focus_sound()
                print('关闭对焦声音')

            elif beauty_parametrize_info == 'logo_on':
                self.setting.on_off_logo()
                print('开启品牌水印')

            elif beauty_parametrize_info == 'position_logo_on':
                self.setting.on_off_position_logo()
                print('开启地理位置水印')

            elif beauty_parametrize_info == 'time_logo_on':
                self.setting.on_off_time_logo()
                print('开启时间水印')

            elif beauty_parametrize_info == 'photo_size_16m_18_9':
                self.setting.photo_size_16m_18_9()
                print('照片大小16M（18:9）')
            elif beauty_parametrize_info == 'photo_size_8m_18_9':
                self.setting.photo_size_8m_18_9()
                print('照片大小8M（18:9）')
            elif beauty_parametrize_info == 'photo_size_8m_4_3':
                self.setting.photo_size_8m_4_3()
                print('照片大小8M（4:3）')
            elif beauty_parametrize_info == 'loc_info_on':
                self.setting.save_location_information()
                print('开启保存位置信息')
    ...
    # 美颜前置功能 144
    @pytest.mark.parametrize("front_beauty_parametrize_info", front_parametrize_info)
    def test_2_beauty_photo_facing(self, front_beauty_parametrize_info):
        ...
        try:
            # 开关
            if front_beauty_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif front_beauty_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')

            elif front_beauty_parametrize_info == 'face_attribute_on':
                self.setting.on_off_face_attribute()
                print('开启人脸属性')

            elif front_beauty_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif front_beauty_parametrize_info == 'time_delay_off':
                self.setting.time_delay()
                print('关闭零延时')

            elif front_beauty_parametrize_info == 'shutter_sound_off':
                self.setting.shutter_sound()
                print('关闭快门声音')

            elif front_beauty_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif front_beauty_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif front_beauty_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif front_beauty_parametrize_info == 'logo_on':
                self.setting.on_off_logo()
                print('开启品牌水印')

            elif front_beauty_parametrize_info == 'position_logo_on':
                self.setting.on_off_position_logo()
                print('开启地理位置水印')

            elif front_beauty_parametrize_info == 'time_logo_on':
                self.setting.on_off_time_logo()
                print('开启时间水印')

            elif front_beauty_parametrize_info == 'photo_size_8m_18_9':
                self.setting.photo_size_8m_18_9()
                print('照片大小8M（18:9）')
            elif front_beauty_parametrize_info == 'photo_size_2m_16_9':
                self.setting.photo_size_2m_16_9()
                print('照片大小2M（18:9）')
            elif front_beauty_parametrize_info == 'photo_size_2m_4_3':
                self.setting.photo_size_2m_4_3()
                print('照片大小2M（4:3）')

            elif front_beauty_parametrize_info == 'loc_info_on':
                self.setting.save_location_information()
                print('开启保存位置信息')
    ...
    @pytest.mark.parametrize("panorama_parametrize_info",
                             ['default','grid_lines_on',  'shutter_sound_off'])
    def test_3_panorama(self, panorama_parametrize_info):
        global state
        try:
            if panorama_parametrize_info == 'default':
                # self.setting.ace_recognition()
                main_page.panorama_photo(self.base_obj)
                print('默认功能组合')
            # 开关网格线
            elif panorama_parametrize_info == 'grid_lines_on':
    ...
    def test_4_video(self, video_parametrize_info):
        ...
        global state
        try:
            if video_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关网格线
            elif video_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')
    ...
    def test_4_video_facing(self, front_video_parametrize_info):
        ...
        global state
        try:
            if front_video_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关网格线
            elif front_video_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')
    ...
    # 美视 140
    @pytest.mark.parametrize("apparent_parametrize_info", video_parametrize_info)
    def test_5_apparent(self, apparent_parametrize_info):
        ...
        global state
        try:
            if apparent_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关网格线
            elif apparent_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif apparent_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif apparent_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif apparent_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif apparent_parametrize_info == 'Focus_sound_off':
                self.setting.Focus_sound()
                print('关闭对焦声音')

            elif apparent_parametrize_info == 'stabilization_on':
                self.setting.on_off_stabilization()
                print('开启防抖')

            if apparent_parametrize_info == 'FHD':
                self.setting.video_quality()
                self.setting.video_fhd()
                print('视频画质FHD')
            elif apparent_parametrize_info == 'VGA':
                self.setting.video_quality()
                self.setting.video_vga()
                print('视频画质VGA')

            elif apparent_parametrize_info == 'loc_info_on':
                self.setting.less_save_location_information()
                print('开启保存位置信息')
    ...
    # 前置摄像头美视功能 40
    @pytest.mark.parametrize("front_apparent_parametrize_info", front_video_parametrize_info)
    def test_5_apparent_facing(self, front_apparent_parametrize_info):
        ...
        global state
        try:
            if front_apparent_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关网格线
            elif front_apparent_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif front_apparent_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif front_apparent_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif front_apparent_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif front_apparent_parametrize_info == 'FHD':
                self.setting.video_quality()
                self.setting.video_fhd()
                print('视频画质FHD')
            elif front_apparent_parametrize_info == 'VGA':
                self.setting.video_quality()
                self.setting.video_vga()
                print('视频画质VGA')

            elif front_apparent_parametrize_info == 'loc_info_on':
                self.setting.less_save_location_information()
                print('开启保存位置信息')
    ...
    def test_6_portrait(self, portrait_parametrize_info):
        ...
        global state
        try:
            if portrait_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif portrait_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    def test_6_portrait_facing(self, front_portrait_parametrize_info):
        ...
        global state
        try:
            if front_portrait_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif front_portrait_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    # 后置儿童模式 208
    @pytest.mark.parametrize("kid_parametrize_info", parametrize_info)
    def test_6_kid(self, kid_parametrize_info):
        # 进入儿童模式
        ...
        try:
            # 开关
            if kid_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif kid_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')

            elif kid_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif kid_parametrize_info == 'time_delay_off':
                self.setting.time_delay()
                print('关闭零延时')

            elif kid_parametrize_info == 'shutter_sound_off':
                self.setting.shutter_sound()
                print('关闭快门声音')

            elif kid_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif kid_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif kid_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif kid_parametrize_info == 'Focus_sound_off':
                self.setting.Focus_sound()
                print('关闭对焦声音')

            elif kid_parametrize_info == 'logo_on':
                self.setting.on_off_logo()
                print('开启品牌水印')

            elif kid_parametrize_info == 'position_logo_on':
                self.setting.on_off_position_logo()
                print('开启地理位置水印')

            elif kid_parametrize_info == 'time_logo_on':
                self.setting.on_off_time_logo()
                print('开启时间水印')

            elif kid_parametrize_info == 'photo_size_16m_18_9':
                self.setting.photo_size_16m_18_9()
                print('照片大小16M（18:9）')
            elif kid_parametrize_info == 'photo_size_8m_18_9':
                self.setting.photo_size_8m_18_9()
                print('照片大小8M（18:9）')
            elif kid_parametrize_info == 'photo_size_8m_4_3':
                self.setting.photo_size_8m_4_3()
                print('照片大小8M（4:3）')
            elif kid_parametrize_info == 'loc_info_on':
                self.setting.save_location_information()
                print('开启保存位置信息')
    ...
    def test_6_kid_facing(self, front_kid_parametrize_info):
        ...
        try:
            # 开关
            if front_kid_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关人脸识别
            elif front_kid_parametrize_info == 'face_recognition_off':
    ...
    # 后置模特模式 160
    @pytest.mark.parametrize("model_parametrize_info", parametrize_info)
    def test_6_model_pattern(self, model_parametrize_info):
        # 进模特模式
        ...
        try:
            # 开关
            if model_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            elif model_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')

            elif model_parametrize_info == 'grid_lines_on':
                self.setting.Grid_lines()
                print('开启网格线')

            elif model_parametrize_info == 'time_delay_off':
                self.setting.time_delay()
                print('关闭零延时')

            elif model_parametrize_info == 'shutter_sound_off':
                self.setting.shutter_sound()
                print('关闭快门声音')

            elif model_parametrize_info == 'avodi_flashing_off':
                self.setting.avodi_flashing_off()
                print('避免闪烁关闭')
            elif model_parametrize_info == 'avodi_flashing_60hz':
                self.setting.avodi_flashing_60hz()
                print('避免闪烁60hz')
            elif model_parametrize_info == 'avodi_flashing_50hz':
                self.setting.avodi_flashing_50hz()
                print('避免闪烁50hz')
            elif model_parametrize_info == 'Focus_sound_off':
                self.setting.Focus_sound()
                print('关闭对焦声音')

            elif model_parametrize_info == 'logo_on':
                self.setting.on_off_logo()
                print('开启品牌水印')

            elif model_parametrize_info == 'position_logo_on':
                self.setting.on_off_position_logo()
                print('开启地理位置水印')

            elif model_parametrize_info == 'time_logo_on':
                self.setting.on_off_time_logo()
                print('开启时间水印')

            elif model_parametrize_info == 'photo_size_16m_18_9':
                self.setting.photo_size_16m_18_9()
                print('照片大小16M（18:9）')
            elif model_parametrize_info == 'photo_size_8m_18_9':
                self.setting.photo_size_8m_18_9()
                print('照片大小8M（18:9）')
            elif model_parametrize_info == 'photo_size_8m_4_3':
                self.setting.photo_size_8m_4_3()
                print('照片大小8M（4:3）')
            elif model_parametrize_info == 'loc_info_on':
                self.setting.save_location_information()
                print('开启保存位置信息')
    ...
    def test_6_watermark(self, watermark_parametrize_info):
        ...
        global state
        try:
            if watermark_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif watermark_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    def test_6_watermark_facing(self, front_watermark_parametrize_info):
        ...
        global state
        try:
            if front_watermark_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif front_watermark_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    def test_6_myotee(self, myotee_parametrize_info):
        ...
        global state
        try:
            if myotee_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif myotee_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
    ...
    def test_6_myotee_facing(self, front_myotee_parametrize_info):
        ...
        global state
        try:
            if front_myotee_parametrize_info == 'default':
                # self.setting.ace_recognition()
                print('默认功能组合')
            # 开关
            elif front_myotee_parametrize_info == 'face_recognition_off':
                self.setting.ace_recognition()
                print('关闭人脸识别')
...
if __name__ == '__main__':
    # state = 'T'
    pytest.main(['-s', '-r', 'testcase_simplify2.py'])
